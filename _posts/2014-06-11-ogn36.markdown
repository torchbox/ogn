...
<ul class="keynotes">
    ...
    <li itemprop="performer" itemscope="itemscope" itemtype="http://schema.org/Person">
        <a href="#"><h2 itemprop="name">To be announced</h2></a>
        <p>To be announced</p>
        <!--
        <div class="downloads">
            <a href="/">Slides</a>
