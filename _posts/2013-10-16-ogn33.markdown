...
<script type="text/javascript">
  var d = jQuery("<div id='digitaloxfordweek'></div>")
    .css({"position": "absolute", "display": "block", "top": "12px", "right": "12px"})
    .appendTo("body");
  var a = jQuery('<a></a>')
    .attr("href", "http://www.digitaloxford.com/weekoctober2013/")
    .appendTo(d);
  jQuery('<img></img>')
    .attr("src", "http://www.digitaloxford.com/img/digital-oxford-badge.png").appendTo(a);
</script>
