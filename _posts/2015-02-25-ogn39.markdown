...
<ul class="microslots">
    <li itemprop="performer" itemscope="itemscope" itemtype="http://schema.org/Person">
        <a href="" itemprop="url"><h2 itemprop="name">Howard Noble</h2></a>
        <p>Computer Gaming in Academic Research</p>
    </li>
    <li itemprop="performer" itemscope="itemscope" itemtype="http://schema.org/Person">
    ...
    <li itemprop="performer" itemscope="itemscope" itemtype="http://schema.org/Person">
        <a href="http://torchbox.com" itemprop="url"><h2 itemprop="name">Nick Smith</h2></a>
        <p>iShamba</p>
    </li>
</ul>
